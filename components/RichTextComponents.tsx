...
export const RichTextComponents={
    ...
    list: {
      ...
      // By clicking LogIn or Continue with google , you aggry to our Tearms and Conditions and Privacy Statements
    block: {
        ...
        blockquote: ({children}:any) =>(<blockquote className=" border-l-[#F7AB0A] border-l-4 pl-5 py-5 my-5">{children}
        </blockquote>
        ),
      },
    marks:{
